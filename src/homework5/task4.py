...
analyze = AnalyzeFilms(
    films.get_films_dict())    # Одну гистограмму сдела в txt файле
analyze.plot_hist_years()      # Другую с помощью matplotlib.
analyze.plot_hist_rank()       # Файлы поместил в папку task4_output_files
