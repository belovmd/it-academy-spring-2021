...
def dir_reduc(arr):
    ...
    Write a function dir_reduc which will take an array of strings and returns an array of strings with the needless
...
def snail(matrix):
    ...
    for turn in range(turns):
        # excluder avoids duplication of the central element in a matrix with an odd number of elements
